...
const NicknameEdit = () => {
  ...
  const handleCheckDuplicate = async () => {
    ...
    try {
      const response = await fetch('https://mannajang.store/api/user/login-check-name', {
        method: 'POST',
        headers: {
  ...
  const handleSubmit = async () => {
    ...
    console.log('닉네임 변경 Request:', {
      url: 'https://mannajang.store/api/user/profile/name',
      method: 'PUT',
      headers: {
        'Authorization': `Bearer ${token}`,
        'Content-Type': 'application/json'
    ...
    try {
      const response = await fetch('https://mannajang.store/api/user/profile/name', {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`,
